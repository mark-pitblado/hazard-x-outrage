...
import covidImage from "../assets/covid_image.jpg";

const Info = () => {
  return (
    <div className="flex overflow-x-hidden w-full h-screen bg-slate-100">
      <div className="flex flex-col pl-20 pt-20">
        ...
        <p className="text-slate-800 text-left mt-10 text-2xl">
          In situtions where there is a clear and present danger that people
